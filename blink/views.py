    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if camera_access:
                ...
                return JsonResponse({'status': 'success', 'message1': f'Starting blink detection for 30 seconds.'})
...
def get_final_message(request):
    global TOTAL_BLINKS
    if TOTAL_BLINKS < 8:
        message1 = "Irregular blinks—Keep an eye on your eye health."
    else:
        message1 = "Healthy blinks—Your eyes are in good shape!"
    return JsonResponse({'message1': message1})
